...
app.use(cors(
    {
        origin:["https://vercel.com/akhil964892s-projects/e-commerce"],
        methods:["POST","GET"],
        credentials:true
    }
));
...
//creating endpoint for uaser login
app.post('/login',async(req,res)=>{
    ...
    if(user){
        ...
        res.json({success:false,errors:"Wrong Email I'd"});
    }
})
...
//creating endpoint for popular in category
app.get('/popular',async (req,res)=>{
    let products=await Product.find({category:"personalized"});
